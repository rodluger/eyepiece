...
class _kill_pool_message(object):
    def __repr__(self):
        return "<Kill pool message>"
...
class MPIPool(object):
    ...
    def wait(self):
        ...
        while True:
            ...
            # BUG: The next line occasionally fails with the following error:
            '''
            Other MPI error, error stack:
            MPI_Probe(113).....................: MPI_Probe(src=0, tag=MPI_ANY_TAG, MPI_COMM_WORLD, status=0x7fff4bf61fd0) failed
    ...
    def map(self, function, tasks):
        ...
        if (not self.loadbalance) or (ntask <= self.size):
            ...
            for i in range(ntask):
                ...
                # NOTE: This probably won't work since we're not 
    ...
    def kill(self):
      '''
      NOTE: This may only work when load_balancing is enabled...
      
      '''
      self.comm.isend(_kill_pool_message(), dest=0)
